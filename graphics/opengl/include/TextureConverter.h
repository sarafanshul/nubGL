...
public:
    TextureConverter(GLsizei width, GLsizei height) : m_width(width), m_height(height) {
    ...
    void convert(GLuint inputTextureId, GLuint externalTextureId) {
